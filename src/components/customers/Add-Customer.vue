<template>
  <div class="container">
    <h1 class="pb-5">Agregar cliente</h1>
    ...
    <form @submit.prevent="handleSubmit" class="row">
        ...
        <input
          ...
          :class="{
            'is-invalid':
              ...
              (validationErrors.dni.pattern || validationErrors.dni.required),
            'is-valid':
              validationErrors.dni.touched &&
        ...
        <input
          ...
          :class="{
            'is-invalid':
              ...
              (validationErrors.email.required || validationErrors.email.pattern),
            'is-valid':
              validationErrors.email.touched &&
      ...
      <div class="col-12 col-md-4 mb-3">
        ...
        />
        <span
          v-if="validationErrors.phone_number.required"
          class="phone_number-required text-danger"
...
const validationErrors = ref({
  dni: { touched: false, required: false, pattern: false },
  first_name: { touched: false, required: false, too_short: false, too_long: false },
  email: { touched: false, required: false, pattern: false },
...
const createCustomer = async () => {
  ...
  if (response.error) {
    ...
    showRequestResult.value.success = false // Muestra el error con color rojo
    showRequestResult.value.message =
      response.error == 'The dni has already been taken.'
  ...
  showRequestResult.value.show = true
  showRequestResult.value.success = true // Mensaje en verde
  showRequestResult.value.message = 'Cliente creado correctamente.'
}
</script>
